          ...
          <v-form class="px-3">
            <v-card-text>
              <v-row>
                ...
                <v-col cols="12" sm="4" >
                  <v-text-field  append-inner-icon="mdi-pencil"   v-model="credData.title" class="mt-4" variant="solo" density="compact"/>
                </v-col>
                <v-spacer></v-spacer>
                <v-btn class='mt-5 md-5' icon="mdi-plus" 
                  title="Add New Text Field">
                </v-btn>               
                <v-btn 
                  title="Add to Favorite List" 
                  class='mt-5 md-5 ml-2' icon >
            ...
            <v-card-actions>
              <v-spacer></v-spacer>
              <v-btn title="Hide User" > Cancel </v-btn>
              <v-btn  title="Save User"  color="customColor5"> Save</v-btn>
            </v-card-actions>
          </v-form>
        </v-card>
</template>
